...
export default function Attendance() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold font-display text-white">Attendance</h1>
        <p className="text-slate-400 text-sm mt-0.5">Mark and review daily attendance records</p>
      </div>
